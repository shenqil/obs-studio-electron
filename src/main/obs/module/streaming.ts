...
// destroy：推流输出持有 video canvas，必须在 core 销毁 videoContext 之前停掉。
//       监听根触发 lifecycle:destroy 立即 forceStop，用 try/finally 保证 streaming:destroyed
//       无条件发出（core 的销毁 onAll 在等它）。
